      ...
      tags$div(
        ...
        tags$h2(
          ...
          tags$button(
            ...
            type = "button",
            "data-bs-toggle" = "collapse",
            "data-bs-target" = "#collapseVariaveis",
            "aria-expanded" = "true",
            "aria-controls" = "collapseVariaveis",
            "Variáveis"
          )
        ),
        tags$div(
          id = "collapseVariaveis", class = "accordion-collapse collapse",
          "data-bs-parent" = "#variaveis",
          shinyWidgets::pickerInput(
            "Selecione uma variável socioeconômica",
            inputId = "biv_var_1",
            choices = list(
              `Variáveis de desigualdade social` = var_desi
            )
          ),
          ## Seletor da primeira variável ----
          uiOutput("extra_ind_desi_socio"),
          shinyWidgets::pickerInput(
            "Selecione a segunda variável do indivíduo",
            inputId = "biv_var_2",
            choices = list(
              `Variáveis do indivíduo` = var_ind
            ),
            selected = "Faixa etária"
          ),
          ## Seletor da segunda variável ----
          uiOutput("extra_indiv")
        )
      )
    )
  ),
